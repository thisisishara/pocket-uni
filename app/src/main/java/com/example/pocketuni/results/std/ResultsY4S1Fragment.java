...
public class ResultsY4S1Fragment extends Fragment {
    ...
    private static  final  String TAG = "RST FRAG SEVEN";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_results_y4_s1, container, false);
    ...
    private void showData() {
        final String TAG = "GET RSLTS FRAG SEVEN";

        firebaseAuth = FirebaseAuth.getInstance();
        firebaseFirestore = FirebaseFirestore.getInstance();

        email = CurrentUser.getEmail();
        String yearAndSem = "Year Four Semester One";
