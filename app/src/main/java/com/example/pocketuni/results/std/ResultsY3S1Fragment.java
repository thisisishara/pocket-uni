...
public class ResultsY3S1Fragment extends Fragment {
    ...
    private static  final  String TAG = "RST FRAG FIVE";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_results_y3_s1, container, false);
    ...
    private void showData() {
        final String TAG = "GET RSLTS FRAG FIVE";

        firebaseAuth = FirebaseAuth.getInstance();
        firebaseFirestore = FirebaseFirestore.getInstance();

        email = CurrentUser.getEmail();
        String yearAndSem = "Year Three Semester One";
