...
public class ResultsY2S2Fragment extends Fragment {
    ...
    private static  final  String TAG = "RST FRAG FOUR";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_results_y2_s2, container, false);
    ...
    private void showData() {
        final String TAG = "GET RSLTS FRAG FOUR";

        firebaseAuth = FirebaseAuth.getInstance();
        firebaseFirestore = FirebaseFirestore.getInstance();

        email = CurrentUser.getEmail();
        String yearAndSem = "Year Two Semester Two";
