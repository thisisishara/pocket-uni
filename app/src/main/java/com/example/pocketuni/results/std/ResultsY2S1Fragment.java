...
public class ResultsY2S1Fragment extends Fragment {
    ...
    private static  final  String TAG = "RST FRAG THREE";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_results_y2_s1, container, false);
    ...
    private void showData() {
        final String TAG = "GET RSLTS FRAG THREE";

        firebaseAuth = FirebaseAuth.getInstance();
        firebaseFirestore = FirebaseFirestore.getInstance();

        email = CurrentUser.getEmail();
        String yearAndSem = "Year Two Semester One";
