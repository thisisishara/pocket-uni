...
public class ResultsY1S1Fragment extends Fragment {
    private View view;
    TextView module, grade, caMarks, caPeriod, textViewSemGpa, textViewSemPassStatus;
    TableLayout tableLayout;
    TableRow tableRow;
    private List<Result> resultList = new ArrayList<>();
    private static  final  String TAG = "RST FRAG ONE";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_results_y1_s1, container, false);
    ...
    private void showData() {
        final String TAG = "GET RSLTS FRAG ONE";
