...
public class ResultsY4S2Fragment extends Fragment {
    ...
    private static  final  String TAG = "RST FRAG EIGHT";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_results_y4_s2, container, false);
    ...
    private void showData() {
        final String TAG = "GET RSLTS FRAG EIGHT";

        firebaseAuth = FirebaseAuth.getInstance();
        firebaseFirestore = FirebaseFirestore.getInstance();

        email = CurrentUser.getEmail();
        String yearAndSem = "Year Four Semester Two";
