...
public class ResultsY1S2Fragment extends Fragment {
    ...
    private static  final  String TAG = "RST FRAG TWO";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_results_y1_s2, container, false);
    ...
    private void showData() {
        final String TAG = "GET RSLTS FRAG TWO";

        firebaseAuth = FirebaseAuth.getInstance();
        firebaseFirestore = FirebaseFirestore.getInstance();

        email = CurrentUser.getEmail();
        String yearAndSem = "Year One Semester Two";
